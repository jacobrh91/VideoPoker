...
public class StrategyHelper {
	...
	SimulatorApp.getStrats().addListener(new ListChangeListener<String>() {
		...
		//Prevents checking for strats immediately after the array is cleared
	...
	/*
	 * cred_wrappers hold borders that show even
	 * when inside values are invisible
	 */
	...
	/*
	 * Obtains the same shuffled deck used in VideoInterface instance
	 * and resets the top card count so the hands will match up
	 */
